...
import yaml
import torch
from model.sdcluster_o import SDCLuster
...
# import sys
# sys.path.append('/home/mamingrui/sod/ultralytics-main/')
# from train_1_pre import get_b
...
class Trainer():
    ...
    def save(self):
        if self.rank == 0:
            torch.save(self.net.module.encoder_k.state_dict(), self.path + '/backbone.pt')
            print('save')
...
if __name__ == '__main__':
    all_pre('/home/mamingrui/sod/ultralytics-main/SDCluster-main/save', '/home/mamingrui/sod/visdrone/VisDrone2019-DET-train/images/', '/home/mamingrui/sod/ultralytics-main/my_model/vhr_yolov8s_pre_res.yaml')
