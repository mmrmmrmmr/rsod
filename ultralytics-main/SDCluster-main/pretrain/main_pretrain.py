...
class Trainer():
    ...
    def save(self):
        if self.rank == 0:
            torch.save(self.net.module.encoder_q.state_dict(), '/home/mamingrui/sod/ultralytics-main/SDCluster-main/save/backbone.pt')
            print('save')
...
if __name__ == '__main__':
    ...
    dataset = DataSet_iSAID_Pretrain(args, '/home/mamingrui/sod/VHR/images/')
