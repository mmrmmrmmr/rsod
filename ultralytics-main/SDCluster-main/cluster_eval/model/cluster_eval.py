...
class ClusterEval(nn.Module):
    def __init__(self, args):
        ...
        model_path_yaml = "/home/mamingrui/sod/ultralytics-main/my_model/vis_yolov8s_scam_my3bone2l_3bicross4neck256256256_4fem_my3head_pre.yaml"
        self.encoder, _ = get_b(model_path_yaml)
    ...
    def forward(self, x):
        with torch.no_grad():
            ...
            probs = self.assign(self.projector(self.encoder(x)))
            # probs = self.projector(self.encoder(x))
